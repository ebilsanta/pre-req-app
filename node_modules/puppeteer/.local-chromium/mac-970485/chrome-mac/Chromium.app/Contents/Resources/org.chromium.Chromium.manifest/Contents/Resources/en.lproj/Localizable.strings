...
WindowPlacementAlwaysAllowed.pfm_title = "Enable window placement permission on all sites";
WindowPlacementAlwaysAllowed.pfm_description = "When this policy is set to Enabled, the window placement permission is automatically granted for all sites.\nThis will allow sites to see and use information about connected screens to open and place windows.\nIf not set or Disabled, this policy will follow the browser's defaults and allow users to choose this permission per site.";